...
function normalizeTime(value: string): string | null {
    ...
    // Prosoft and some systems represent post-midnight times as 24+ (e.g. "25:30" = 01:30 next day).
    // Normalize to 0–23 range; computeHours already detects overnight via end < start.
