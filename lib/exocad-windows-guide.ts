...
export const EXOCAD_WINDOWS_GUIDE: ExocadWindowsGuide = {
    ...
    humanSteps: [
        ...
        'Desde la tarjeta del proyecto, usa "Probar guardado" para comprobar en segundos que esa PC puede crear, renombrar, leer y eliminar un archivo temporal en la unidad de Google Drive.',
    ...
    technicalNotes: [
        ...
        'El lanzador 2.1 puede probar la escritura en la unidad de Drive sin abrir Exocad; cuando se diseña, espera el cierre de Exocad, compara hashes SHA-256, respalda los originales, copia solamente los archivos modificados y vuelve a comprobarlos en la carpeta de Drive.',
