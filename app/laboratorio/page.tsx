...
export default function LaboratorioPage() {
    ...
    (t.paciente?.nombre?.toLowerCase().includes(search.toLowerCase()) ||
        t.paciente?.apellido?.toLowerCase().includes(search.toLowerCase()) ||
        t.tipo_trabajo.toLowerCase().includes(search.toLowerCase()))
    );
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-sm text-gray-500">Recibidos (En Clínica)</p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
                {loading ? (
                    ...
                    <div className="p-20 text-center text-gray-500">
                        ...
                        <p className="text-sm">Probá cambiando los filtros o agregando uno nuevo.</p>
                    </div>
                ) : (
