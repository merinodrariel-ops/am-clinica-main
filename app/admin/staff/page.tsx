        ...
        <div className="max-w-7xl mx-auto space-y-10 animate-in fade-in duration-700 pb-16">
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-indigo-500/5 border border-indigo-500/20 rounded-2xl p-5 text-center">
                    <p className="text-3xl font-black text-indigo-400">{withAccess.length}</p>
                    <p className="text-slate-500 text-xs font-bold uppercase tracking-wider mt-1">Portal Activo</p>
                </div>
            </div>
                                    ...
                                    >
                                        <div className="flex items-start justify-between mb-4">
                                            <div className="flex items-center gap-3">
                                                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-700 flex items-center justify-center text-white font-black text-lg shadow-lg shadow-indigo-500/20 overflow-hidden shrink-0">
                                                    {worker.foto_url ? (
                                            ...
                                            <div className={`flex items-center gap-1.5 px-2 py-1 rounded-full text-[10px] font-bold uppercase border shrink-0 ${
                                                worker.activo !== false
                                        ...
                                        <div className="flex flex-wrap gap-2 mb-3">
                                            <span className={`text-[10px] font-bold px-2.5 py-1 rounded-full border ${badge.className}`}>
                                                {badge.label}
                                            </span>
                                            {worker.documento && (
                                        ...
                                        {worker.email && !worker.user_id && (
                                            <div className="mb-3 space-y-2">
                                                ...
                                                <button
                                                    ...
                                                    className="w-full flex items-center justify-center gap-2 py-2 text-xs font-bold text-indigo-400 bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-500/20 rounded-xl transition-colors disabled:opacity-50"
                                                >
                                                    {sendingInvite === worker.id ? (
                                                        <span className="animate-pulse">Enviando...</span>
                                                    ) : (
                                                        <><Send size={12} />Enviar invitación</>
                                                    )}
                                                </button>
                                            </div>
                                        )}
