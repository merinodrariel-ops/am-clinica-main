-- Restore the recovery queue used when a recorded installment cannot be matched
-- or credited to its financing plan. This migration is intentionally idempotent.
