...
import { Upload, Search, CheckCircle2, AlertTriangle, XCircle, RefreshCw, FileSpreadsheet, UserCheck, UserX } from 'lucide-react';
import { toast } from 'sonner';
import { previewProsoftImport, importProsoftData, ProsoftPreview, ProsoftRow } from '@/app/actions/prosoft-import';
                ...
                <div className="space-y-4">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            {!fila.personalId && (
                                                <p className="text-xs text-amber-400">Sin coincidencia en el sistema</p>
                                            )}
                                        </div>
                                    </div>
                    ...
                    {unmatchedRows.length > 0 && (
                        <div className="flex items-start gap-2 p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl text-xs text-amber-300">
                            ...
                            <p>
                                <strong>{unmatchedRows.length} empleados</strong> no tienen coincidencia y serán omitidos:{' '}
