                                ...
                                {budgetPanelOpen && (
                                    ...
                                    >
                                                ...
                                                {PHOTO_BUDGET_PRESETS.map(preset => {
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            disabled={selected || budgetDraft.length >= 6}
                                        ...
                                        <div className="mt-3 flex items-center justify-between gap-2">
                                            <button disabled={budgetDraft.length >= 6} onClick={() => setBudgetDraft(current => [...current, { title: '', description: '', total: 0, currency: 'USD' }])} className="text-xs font-semibold text-[#C9A96E] disabled:opacity-40">+ Agregar alternativa</button>
